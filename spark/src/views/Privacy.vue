<template>
    <div class="container-fluid privacy-wrapper" id="PrivacyPage">
        <div class="container privacy">
            <h1>Cookie Policy for Spark</h1>

            <p>This is the Cookie Policy for Spark, accessible from https://sparkweb.netlify.app/#/</p>
            ...
            <ul>
            <li>Email: goan.hauquier@gmail.com</li>

            </ul>
            <router-link to='/privacy#PrivacyPage'>Privacy</router-link>
